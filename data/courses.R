...
courses <- tribble(
     ...
     "Course", "Leeds Beckett University", "Leeds, England", "2017",
     "Understanding statistics and data analysis in R. This five-day course led by Professor Clive Beggs aimed to equip students and staff with the understanding necessary to undertake post-graduate research. The course covered topics such as variance & probability, parametric hypothesis testing, non-parametric testing, generalized linear models, bootstrapping & Monte Carlo techniques, and introduction to machine learning.",
